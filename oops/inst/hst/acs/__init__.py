...
def from_opened_fitsfile(hst_file, parameters={}):
    ...
    if detector == "HRC":
        return oops.instrument.hst.acs.hrc.from_opened_fitsfile(
                                    hst_file, parameters)

    if detector == "WFC":
        return oops.instrument.hst.acs.wfc.from_opened_fitsfile(
                                    hst_file, parameters)

    if detector == "SBC":
        return oops.instrument.hst.acs.sbc.from_opened_fitsfile(
                                    hst_file, parameters)
...
class ACS(oops.instrument.hst.HST):
