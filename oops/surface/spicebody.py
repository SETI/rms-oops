################################################################################
# oops/surface/spicebody.py: Handles bodys shaped defined in the SPICE toolkit.
#
...
def spice_body(spice_id):
    ...
    spice_body_id = SpicePath.spice_id_and_name(spice_id)[0]
    origin_id = SpicePath.TRANSLATION[spice_body_id]

    spice_frame_name = SpiceFrame.spice_id_and_name(spice_id)[1]
    frame_id = SpiceFrame.TRANSLATION[spice_frame_name]
