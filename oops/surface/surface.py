...
#
#         #--------------------------------------------------------
#         # Iterate. Convergence is rapid because all speeds are
#         # non-relativistic
#         #--------------------------------------------------------
#         max_dlt = np.inf
#         new_lt = False
