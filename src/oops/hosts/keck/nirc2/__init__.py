...
def from_file(filespec, **parameters):
    """An Observation based on a data file generated by Keck/NIRC2.
    ...
    Returns:
        Snapshot: The observation described by the file.

    Raises:
        IOError: If the file was not generated by Keck/NIRC2 or its camera is not
            supported.
    """
...
#*******************************************************************************
class NIRC2(Keck):
    """The functions and properties unique to the NIRC2 instrument.

    Everything else is inherited from higher levels in the class hierarchy. Objects of
    this class are empty; they only exist to support inheritance.
    """
    ...
    def define_fov(self, keck_file, **parameters):
        """The FOV defining the field of view of the given image file.
        ...
        Returns:
            FlatFOV: The 1024x1024 field of view at the pixel scale of the camera named
            in the header, with the vertical axis flipped unless INSTFLIP is "yes".
        """
...
#        eloff = 0. #keck_file[0].header["ELOFF"]
    ...
    def from_opened_fitsfile(keck_file, **parameters):
        """An Observation based on an open Keck/NIRC2 data file.

        Parameters:
            keck_file (astropy.io.fits.HDUList): The HDU list of the FITS file.
            **parameters (Any): Passed on to
                :meth:`~oops.hosts.keck.Keck.construct_snapshot`.

        Returns:
            Snapshot: The observation described by the file.

        Raises:
            IOError: If the camera is not "narrow", "medium" or "wide".
        """
