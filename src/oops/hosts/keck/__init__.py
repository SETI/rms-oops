...
def from_file(filespec, **parameters):
    """An Observation based on a data file generated by the Keck Telescope.

    Parameters:
        filespec (str | pathlib.Path | FCPath): Path to the FITS file.
        **parameters (Any): Passed on to the instrument-specific reader; no keys are
    ...
    Raises:
        IOError: If the file was not generated by Keck II or its instrument is not
            supported.
    """
...
class Keck(object):
    """This class defines functions and properties unique to the Keck Telescope.
    ...
    def instrument_name(self, keck_file):
        ...
        Returns:
            str: The value of the CURRINST keyword in the primary header.
        """

        return keck_file[0].header["CURRINST"]

    def detector_name(self, keck_file, **parameters):
        """The name of the Keck detector used to obtain this file.
        ...
        Returns:
            str: The value of the CAMNAME keyword in the primary header.
        """
    ...
    def data_array(self, keck_file, **parameters):
        ...
        Returns:
            numpy.ndarray: The data array of the primary HDU.
        """
    ...
    def target_body(self, keck_file):
        ...
        Raises:
            KeyError: If the target name is not recognized.
        """
    ...
    def construct_snapshot(self, keck_file, **parameters):
        ...
        Parameters:
            keck_file (astropy.io.fits.HDUList): The HDU list of the FITS file.
            **parameters (Any): Passed on to :meth:`define_fov`, :meth:`time_limits` and
                :meth:`data_array`.

        Returns:
            Snapshot: The observation described by the file, observed from the Earth in
            a frame tracking the target body.
        """
...
#        clock = orient - v_wrt_y_deg
    ...
    def from_opened_fitsfile(keck_file, **parameters):
        """An Observation based on a Keck data file.

        Parameters:
            keck_file (astropy.io.fits.HDUList): The HDU list of the FITS file.
            **parameters (Any): Passed on to the instrument-specific reader.
