...
def from_file(filespec, **parameters):
    """An Observation object based on a given data file generated by HST/ACS/HRC.

    Parameters:
        filespec (str | pathlib.Path | FCPath): The path to the HST/ACS/HRC FITS file.
    ...
    Raises:
        IOError: If the file was not generated by HST/ACS/HRC.
    """
...
class HRC(ACS):
    """The functions and properties unique to the ACS/HRC detector.
    ...
    def from_hdulist(hdulist, **parameters):
        """An Observation object based on an HST data file generated by HST/ACS/HRC.
