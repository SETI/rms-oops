...
def from_file(filespec, **parameters):
    """An Observation object based on a given data file generated by HST/ACS.

    Parameters:
        filespec (str | pathlib.Path | FCPath): The path to the HST/ACS FITS file.
    ...
    Raises:
        IOError: If the file was not generated by HST/ACS.
    """
...
class ACS(HST):
    """The functions and properties unique to the ACS instrument.
    ...
    def filter_name(self, hdulist):
        ...
        Returns:
            str: The filter name, or "CLEAR" if both filter wheels are clear.
        """
    ...
    def from_hdulist(hdulist, **parameters):
        """An Observation object based on an HST data file generated by HST/ACS.
        ...
        Raises:
            IOError: If the detector is not HRC, WFC or SBC.
        """
