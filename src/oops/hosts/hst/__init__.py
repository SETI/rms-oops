...
def from_file(filespec, **parameters):
    """An Observation based on a data file generated by the Hubble Space Telescope.

    Parameters:
        filespec (str | pathlib.Path | FCPath): The path to the HST FITS file.
        **parameters (Any): Options controlling how the file is interpreted. The
            recognized keys are:

            * `data` (bool): If False, no data or associated arrays are loaded.
            * `calibration` (bool): If False, no calibration objects are created.
            * `headers` (bool): If False, no header dictionary is returned.
            * `astrometry` (bool): If True, this is equivalent to data=False,
              calibration=False, headers=False.
            * `reference` (Observation): If specified, then the frame of the returned
              observation will employ the same frame as that of the reference
              observation.
            * `target` (str | None): If specified, then this is the name of the target
              body; otherwise, the target body is inferred from the header.
            * `solar_range` (float): If specified, it overrides the distance from the Sun
              to the target body for calibration purposes.
            * `solar_model` (str): The solar flux model, "STIS" or "COLINA".
            * `layer` (int): The index of the FITS HDU holding the image data.
            * `pos_targ` (tuple[float, float]): The POS TARG values, overriding those in
              the header.
            * `platescale` (float): A scale factor applied to the distortion model.

            The instrument-specific modules recognize additional keys, such as `ccd` for
            ACS/WFC and WFPC2 and `mask` for WFPC2.

    Returns:
        Snapshot: The observation, with the data, calibration, header and bandpass
        subfields that the parameters select.

    Raises:
        IOError: If the file was not generated by HST or its instrument is unsupported.
    """
...
class HST(object):
    ...
    def filespec(self, hdulist):
        ...
        Returns:
            str: The path from which the FITS file was opened.
        """
    ...
    def telescope_name(self, hdulist):
        ...
        Returns:
            str: The value of the TELESCOP keyword in the primary header.
        """
    ...
    def instrument_name(self, hdulist):
        ...
        Returns:
            str: The value of the INSTRUME keyword in the primary header.
        """
    ...
    def detector_name(self, hdulist, **parameters):
        ...
        Returns:
            str: The value of the DETECTOR keyword in the primary header.
        """
    ...
    def error_array(self, hdulist, **parameters):
        ...
        Parameters:
            hdulist (astropy.io.fits.HDUList): The opened FITS file.
            **parameters (Any): Additional parameters. The key `layer` (int) selects the
                HDU holding the data; the uncertainties are read from the HDU that
                follows it. The default is 1.

        Returns:
            numpy.ndarray: The array of uncertainties.
        """
    ...
    def quality_mask(self, hdulist, **parameters):
        ...
        Parameters:
            hdulist (astropy.io.fits.HDUList): The opened FITS file.
            **parameters (Any): Additional parameters. The key `layer` (int) selects the
                HDU holding the data; the quality mask is read from the second HDU after
                it. The default is 1.

        Returns:
            numpy.ndarray: The data quality mask.
        """
    ...
    def time_limits(self, hdulist, **parameters):
        ...
        Returns:
            tuple[float, float]: The start and end times of the exposure in seconds TDB.
        """
    ...
    def pos_targ(self, hdulist, **parameters):
        """The POS TARG values `(x,y)` used for this observation.

        The values are specified in the observation's coordinate frame. The result is
        (0., 0.) if the POS TARG values are not found in the file and are not specified in
        the parameter dictionary via an argument `pos_targ`.

        Parameters:
            hdulist (astropy.io.fits.HDUList): The opened FITS file.
            **parameters (Any): Additional parameters. If the key `pos_targ` is present,
                its value is returned in place of the header values.

        Returns:
            tuple[float, float]: The POS TARG values in arcseconds.
        """
    ...
    def register_frame(self, hdulist, fov, suffix='', **parameters):
        """The ID of the frame of the HST observation.

        The frame rotates from J2000 coordinates into the `(u,v)` coordinates of the
        observation.
        ...
        * otherwise, a new PosTarg frame is defined as an offset from the frame of the
        ...
        Parameters:
            ...
            suffix (str, optional): A suffix appended to the frame ID.
            **parameters (Any): Additional parameters. The key `reference` (Observation)
                selects a PosTarg frame defined relative to that observation's frame;
                the keys `layer`, `target` and `pos_targ` are passed on to the frame
                construction.
    ...
    def register_tracker_frame(self, hdulist, fov, suffix="", **parameters):
        """Construct a Tracker frame for the observation.

        This frame ensures that the target object stays at the same location on the CCD
        ...
        Parameters:
            ...
            suffix (str, optional): A suffix appended to the frame ID.
            **parameters (Any): Additional parameters. The key `layer` (int) selects the
                HDU whose header holds the pointing; the key `target` (str | None)
                overrides the target body inferred from the header.

        Returns:
            str | None: The ID of the registered frame, or None if the header does not
            describe a celestial (RA, DEC) coordinate system. If the observation has no
            target, the frame is an inertial C-matrix frame rather than a Tracker frame.
        """
    ...
    def register_postarg_frame(self, hdulist, fov, suffix='', **parameters):
        """The ID of the PosTarg frame for the observation.

        A PosTarg frame is constructed if necessary. Otherwise, this is the ID of the
        frame used by the reference observation.
        ...
        Parameters:
            ...
            suffix (str, optional): A suffix appended to the frame ID.
            **parameters (Any): Additional parameters. The key `reference` (Observation)
                is required; it is the observation whose frame the new frame is offset
                from. The key `pos_targ` overrides the POS TARG values in the header.

        Returns:
            str | Frame: The ID of the new PosTarg frame, or the frame of the reference
            observation if its POS TARG values match those of this observation.
        """
    ...
    def iof_calibration(self, hdulist, fov, extended=True, **parameters):
        """A Calibration for integrating the I/F of point objects in an HST image.

        Parameters:
            hdulist (astropy.io.fits.HDUList): The opened FITS file.
            fov (FOV): The field of view describing the observation.
            extended (bool, optional): True to provide a calibration for extended
                sources, in which case field-of-view distortion is ignored; False to
                provide a calibration object for point sources, in which case the
                distortion of the field of view must be taken into account.
            **parameters (Any): a dictionary of arbitrary parameters.
        ...
        Returns:
            Calibration | None: A calibration that converts from DN to reflectivity, or
            None if the solar range is not given and the target body is unknown.

        Raises:
            IOError: If the file has no PHOTFLAM calibration factor.
        """
    ...
    def target_body(self, hdulist, **parameters):
        ...
        Parameters:
            hdulist (astropy.io.fits.HDUList): The opened FITS file.
            **parameters (Any): Additional parameters. If the key `target` is present, it
                is the name of the target body, or None for no target.

        Returns:
            Body | None: The target body, or None if it cannot be identified.
        """
...
#                 raise ValueError('Target body not identified: ' + targname)
    ...
    def get_headers(self, hdulist, **parameters):
        ...
        Returns:
            list[astropy.io.fits.Header]: The primary header followed by the headers of
            the data, error and quality HDUs.
        """
    ...
    def set_idc_path(self, idc_path):
        """Define the directory path to the IDC files.

        It must be called before any HST files are loaded. The alternative is to define
        the environment variable HST_IDC_PATH.

        Parameters:
            idc_path (str): The directory containing the IDC files and the file
                IDC_FILE_NAME_DICT.txt that associates each instrument and detector with
                one of them.

        Raises:
            IOError: If IDC_FILE_NAME_DICT.txt contains a malformed line.
        """
    ...
    def idc_filespec(self, hdulist):
        """The full path and file name of an IDC file.

        The file is the one associated with the given FITS file object.

        Parameters:
            hdulist (astropy.io.fits.HDUList): The opened FITS file.

        Returns:
            str: The path to the IDC file for this instrument and detector.
        """
    ...
    def load_idc_dict(self, hdulist, keys):
        ...
        Parameters:
            hdulist (astropy.io.fits.HDUList): The opened FITS file.
            keys (tuple[str, ...]): The names of the columns to use as the keys of the
                returned dictionary. For example, if keys = ("FILTER1","FILTER2"), then
                the pair of filter names will be the key into the dictionary.

        Returns:
            dict[tuple, dict[str, Any]]: A dictionary in which each entry is itself a
            dictionary containing the parameter/value pairs from a single row of the IDC
            file. The rows are keyed by a tuple of the values in the columns specified by
            the keys.
        """
    ...
    def construct_idc_fov(self, fov_dict, platescale=1.):
        """The FOV of the full field of view of an HST instrument.

        It is based on a dictionary of associated IDC parameter values.

        Parameters:
            fov_dict (dict[str, Any]): The associated IDC parameters. This is one of the
                entries in the dictionary returned by :meth:`load_idc_dict`.
            platescale (float, optional): A scale factor applied to the pixel size and
                to the distortion coefficients.

        Returns:
            PolynomialFOV: The field of view defined by the IDC parameters.
        """
    ...
    def construct_drz_fov(self, fov_dict, hdulist, platescale=1.):
        """The FOV of the full field of view of a drizzled image.

        A drizzled image is one that has been geometrically reprojected.

        Parameters:
            fov_dict (dict[str, Any]):
                A dictionary defining the associated IDC parameters. This is one of the
                entries in the dictionary returned by :meth:`load_idc_dict`.
            hdulist (astropy.io.fits.HDUList): The opened FITS file.
            platescale (float, optional): A scale factor applied to the pixel size.

        Returns:
            FlatFOV: A Flat FOV object.
        """
    ...
    def construct_fov(self, fov_dict, hdulist, platescale=1.):
        """The FOV associated with an HST instrument.

        It allows for drizzling, for subarrays, overscan pixels and pixel binning.
        ...
        Returns:
            FOV: A FlatFOV for a drizzled image; otherwise the PolynomialFOV defined by
            the IDC parameters, wrapped in a Subarray and a SubsampledFOV as the header
            requires.
        """
    ...
    def set_syn_path(self, syn_path):
        ...
        Parameters:
            syn_path (str): The root directory of the SYN files.
        """
    ...
    def get_syn_path(self):
        ...
        Returns:
            str: The root directory of the SYN files.
        """
    ...
    def load_syn_throughput(self, hdulist, **parameters):
        """A Tabulation of throughput vs. wavelength in Angstroms.

        The tabulation covers the combined set of SYN files returned by
        :meth:`select_syn_files`.

        Parameters:
            hdulist (astropy.io.fits.HDUList): The opened FITS file.
            **parameters (Any): Additional parameters passed to :meth:`select_syn_files`.

        Returns:
            Tabulation: The product of the throughputs of the selected SYN files.
        """
    ...
    def _load_syn_file(self, syn_filename):
        """A Tabulation of throughput vs. wavelength for a single HST SYN file.

        Wavelengths are in Angstroms.

        Parameters:
            syn_filename (str): The path of the SYN file relative to the SYN root
                directory. It may contain glob wildcards, in which case the last
                matching file in sorted order is used.

        Returns:
            Tabulation: The throughput vs. wavelength in Angstroms.

        Raises:
            IOError: If no file matches `syn_filename`.
        """
    ...
    def solar_f(self, hdulist, sun_range=1., model='STIS', **parameters):
        ...
        Parameters:
            ...
            **parameters (Any): Additional parameters passed to the throughput lookup.
    ...
    def bandpass(self, hdulist, model='STIS', **parameters):
        """The solar flux density passed by this filter, as a Tabulation.

        Parameters:
            hdulist (astropy.io.fits.HDUList): The opened FITS file.
            model (str, optional): The name of the solar spectral model.
            **parameters (Any): Additional parameters passed to the throughput lookup.

        Returns:
            Tabulation: Solar flux density vs. wavelength in microns.
        """
    ...
    def compare_pivot_mean(self, hdulist):
        """The pivot wavelength of a SYN file.

        The tuple contains the value derived from the SYN file and that extracted directly
        ...
        Returns:
            tuple[float, float]: The pivot wavelength derived from the SYN files and the
            PHOTPLAM value from the header.
        """
    ...
    def compare_bandwidth_rms(self, hdulist):
        """The RMS bandwidth of a SYN file.
        ...
        Returns:
            tuple[float, float]: The RMS bandwidth derived from the SYN files and the
            PHOTBW value from the header.
        """
    ...
    def from_hdulist(hdulist, **parameters):
        """An Observation based on an HST data file.
        ...
        Returns:
            Snapshot: The observation constructed by the module for the file's instrument.

        Raises:
            IOError: If the file was not generated by HST or its instrument is
                unsupported.
        """
