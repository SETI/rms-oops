...
class HST(object):
    ...
    def pos_targ(self, hdulist, **parameters):
        ...
        The values are specified in the observation's coordinate frame. The result is None
        if the POS TARG values are not found in the file and are not specified in the
        parameter dictionary via an argument `pos_targ`.
        """
    ...
    def iof_calibration(self, hdulist, fov, extended=True, **parameters):
        ...
        Parameters:
            ...
            extended (bool): True to provide a calibration for extended sources, in which
                case field-of-view distortion is ignored; False to provide a calibration
                object for point sources, in which case the distortion of the field of
        ...
        Returns:
            Calibration: A calibration that converts from DN to reflectivity.
        """
...
#                 raise ValueError('Target body not identified: ' + targname)
    ...
    def load_idc_dict(self, hdulist, keys):
        ...
        Returns:
            dict: A dictionary in which each entry is itself a dictionary containing the
    ...
    def construct_idc_fov(self, fov_dict, platescale=1.):
        ...
        Parameters:
            fov_dict (dict): The associated IDC parameters. This is one of the entries
                in the dictionary returned by `load_idc_dict()`.
    ...
    def bandpass(self, hdulist, model='STIS', **parameters):
        ...
        Parameters:
            ...
            **parameters: Additional parameters passed to the throughput lookup.
