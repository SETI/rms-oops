...
def from_file(filespec, **parameters):
    """An Observation object based on a given data file generated by HST/NICMOS/NIC1.

    Parameters:
        filespec (str | pathlib.Path | FCPath): The path to the HST/NICMOS/NIC1 FITS file.
    ...
    Raises:
        IOError: If the file was not generated by HST/NICMOS/NIC1.
    """
    ...
    if this.detector_name(hdulist) != 'NIC1':
        raise IOError(f'not an HST/NICMOS/NIC1 file: {filespec}')

    return NIC1.from_hdulist(hdulist, **parameters)
...
class NIC1(NICMOS):
    """The functions and properties unique to the NIC1 detector.
    ...
    def from_hdulist(hdulist, **parameters):
        """An Observation object based on an HST data file generated by HST/NICMOS/NIC1.
