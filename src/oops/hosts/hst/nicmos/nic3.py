...
def from_file(filespec, **parameters):
    """An Observation object based on a given data file generated by HST/NICMOS/NIC3.

    Parameters:
        filespec (str | pathlib.Path | FCPath): The path to the HST/NICMOS/NIC3 FITS file.
    ...
    Raises:
        IOError: If the file was not generated by HST/NICMOS/NIC3.
    """
...
class NIC3(NICMOS):
    """The functions and properties unique to the NIC3 detector.
    ...
    def from_hdulist(hdulist, **parameters):
        """An Observation object based on an HST data file generated by HST/NICMOS/NIC3.
