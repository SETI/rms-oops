...
def from_file(filespec, **parameters):
    """An Observation object based on a given data file generated by HST/WFC3.

    Parameters:
        filespec (str | pathlib.Path | FCPath): The path to the HST/WFC3 FITS file.
    ...
    Raises:
        IOError: If the file was not generated by HST/WFC3.
    """
...
class WFC3(HST):
    """The functions and properties unique to the WFC3 instrument.
    ...
    def filter_name(self, hdulist):
        """The name of the filter for this particular WFC3 detector.
    ...
    def from_hdulist(hdulist, **parameters):
        """An Observation object based on an HST data file generated by HST/WFC3.
        ...
        Raises:
            IOError: If the detector is not UVIS or IR.
        """
