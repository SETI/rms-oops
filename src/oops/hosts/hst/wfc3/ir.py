...
def from_file(filespec, **parameters):
    """An Observation object based on a given data file generated by HST/WFC3/IR.

    Parameters:
        filespec (str | pathlib.Path | FCPath): The path to the HST/WFC3/IR FITS file.
    ...
    Raises:
        IOError: If the file was not generated by HST/WFC3/IR.
    """
...
class IR(WFC3):
    """The functions and properties unique to the WFC3/IR detector.
    ...
    def from_hdulist(hdulist, **parameters):
        """An Observation object based on an HST data file generated by HST/WFC3/IR.
