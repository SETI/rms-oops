...
def from_file(filespec, **parameters):
    """An Observation object based on a given data file generated by HST/WFC3/UVIS.

    Parameters:
        filespec (str | pathlib.Path | FCPath): The path to the HST/WFC3/UVIS FITS file.
    ...
    Raises:
        IOError: If the file was not generated by HST/WFC3/UVIS.
    """
...
class UVIS(WFC3):
    """The functions and properties unique to the WFC3/UVIS detector.
    ...
    def define_fov(self, hdulist, **parameters):
        """The FOV of the full field of view for the given image file.

        Any subarray is ignored.

        Parameters:
            hdulist (astropy.io.fits.HDUList): The opened FITS file.
            **parameters (Any): Additional parameters. The key `platescale` (float)
                overrides the scale factor applied to the distortion model.
    ...
    def select_syn_files(self, hdulist, **parameters):
        ...
        Parameters:
            hdulist (astropy.io.fits.HDUList): The opened FITS file.
            **parameters (Any): Additional parameters. The key `layer` (int) selects
                the HDU whose header identifies the CCD chip.
                The default is 1.
    ...
    def from_hdulist(hdulist, **parameters):
        """An Observation object based on an HST data file generated by HST/WFC3/UVIS.
