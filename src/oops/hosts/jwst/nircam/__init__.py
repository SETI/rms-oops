...
def from_file(filespec, **options):
    ...
    See :func:`~oops.hosts.jwst.nircam.uncal.from_file` for the additional options
    related to _uncal.fits.
...
class NIRCam(JWST):
    ...
    def header_subfields(self, hdulist, **options):
        ...
        Parameters:
            ...
            **options (Any): The options of :func:`~oops.hosts.jwst.nircam.from_file`,
                interpreted as by :meth:`~oops.hosts.jwst.JWST.header_subfields`.

        Returns:
            dict[str, Any]: The subfields of
            :meth:`~oops.hosts.jwst.JWST.header_subfields` plus "module" and "channel",
            with "detector" reduced to its number or "LONG" and "filter" replaced by the
            pupil name when the pupil holds a filter.
        """
    ...
    def filter_bandpass(self, hdulist, **options):
        ...
        Returns:
            Tabulation: The system throughput as a function of wavelength in microns.
        """
    ...
    def from_hdulist(hdulist, **options):
        ...
        See :func:`~oops.hosts.jwst.nircam.from_file` for the additional options.
