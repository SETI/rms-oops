...
class Frame(Mutable):
    ...
    def pickle_quickframe_details(self, value: bool) -> None: ...
...
class J2000Frame(NullFrame):
    def __new__(cls) -> J2000Frame: ...
    def __init__(self) -> None: ...
    def __reduce__(self) -> tuple[type[J2000Frame], tuple[()]]: ...
    @property
    def string_id(self) -> str: ...
...
class Navigation(Frame, Fittable):
    nparams: int
    def __init__(self, arg: tuple[float, ...] | list[float] | ndarray | Navigation, /,
        reference: Frame | str, *,
