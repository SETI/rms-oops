##########################################################################################
# oops/frame/ringframe.pyi
##########################################################################################
"""Type stub for :mod:`oops.frame.ringframe`.
...
class RingFrame(Frame):
    def __init__(self, frame: Any, epoch: Any = None, *, aries: bool = False,
        retrograde: bool = False, frame_id: Any = None,
