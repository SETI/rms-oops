...
class Gravity(Oops):
    ...
    :meth:`~oops.Gravity.omega`, the radial (epicyclic) oscillation frequency
    :meth:`~oops.Gravity.kappa`, and the vertical oscillation frequency
    :meth:`~oops.Gravity.nu`, along with their radial derivatives and the linear
