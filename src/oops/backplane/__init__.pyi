...
class Backplane(Mutable):
    ...
    @staticmethod
    def get_body_and_modifier(surface_key: Any) -> Any: ...
    @staticmethod
    def unmasked_surface_key(surface_key: Any) -> Any: ...
    @staticmethod
    def unmasked_event_key(event_key: Any) -> Any: ...
    @staticmethod
    def intercept_dict_key(event_key: Any) -> Any: ...
