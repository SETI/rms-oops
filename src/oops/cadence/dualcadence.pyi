##########################################################################################
# oops/cadence/dualcadence.pyi
##########################################################################################
"""Type stub for :mod:`oops.cadence.dualcadence`.
...
class DualCadence(Cadence):
    ...
    min_tstride: Any
    max_tstride: Any
    def __init__(self, long: Any, short: Any) -> None: ...
    ...
    @staticmethod
    def for_array2d(samples: Any, lines: Any, tstart: Any, texp: Any,
        intersample_delay: float = 0.0, interline_delay: Any = None) -> Any: ...
