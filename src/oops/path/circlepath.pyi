##########################################################################################
# oops/path/circlepath.pyi
##########################################################################################
"""Type stub for :mod:`oops.path.circlepath`.
...
class CirclePath(Path):
    def __init__(self, radius: Any, lon: Any, rate: Any, epoch: Any, origin: Any, *,
        frame: Any = None, path_id: Any = None) -> None: ...
