...
class NullPath(Path):
    ...
    def event_at_time(self,  # type: ignore[override]
        time: ScalarLike, *, quick: bool = False) -> Event: ...
...
class CoordPath(Path):
    def __init__(self, surface: Surface, coords: tuple, *, obs: Path | str | None = None,
        path_id: str | None = None) -> None: ...
    def event_at_time(self, time: ScalarLike, *,
        quick: dict | bool | None = None) -> Event: ...
