...
class CirclePath(Path):
    ...
    def __init__(self, radius, lon, rate, epoch, origin, *, frame=None, path_id=None):
        ...
        Parameters:
            ...
            epoch (ScalarLike): The time TDB relative to which all orbital elements are
                defined.
            origin (Path | str): The Path or the ID of the Path at the center of the
                circle.
    ...
    def _waypoint_key(self):
        ...
        Returns:
            tuple[Scalar, Scalar, Scalar, Scalar, Path, Frame]: The radius, longitude,
            rate, epoch, origin, and frame.
        """
