##########################################################################################
# oops/surface/ansa.pyi
##########################################################################################
"""Type stub for :mod:`oops.surface.ansa`.
...
class Ansa(Surface):
    ...
    unmasked: Any
    intercept_key: Any
    def __init__(self, origin: Any, frame: Any, *, gravity: Any = None,
        ringplane: Any = None, radii: Any = None) -> None: ...
    @property
    def ringplane(self) -> Any: ...
    @staticmethod
    def for_ringplane(ringplane: Any) -> Any: ...
    @staticmethod
    def for_body(body: Any) -> Any: ...
