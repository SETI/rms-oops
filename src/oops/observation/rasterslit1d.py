...
class RasterSlit1D(Observation):
    ...
    def uvt(self, indices, *, remask=False, derivs=True):
        ...
        slit_coord = Observation._scalar_from_indices(indices, self.t_axis, derivs=derivs)
    ...
    def uvt_range(self, indices, *, remask=False):
        ...
        slit_coord = Observation._scalar_from_indices(indices, self.t_axis, derivs=False)
    ...
    def time_range_at_uv(self, uv_pair, *, remask=False):
        ...
        # We can't use super._time_range_at_uv_1d because the self.uv_shape is
    ...
    def uv_range_at_time(self, time, *, remask=False):
        ...
        return Observation._uv_range_at_time_1d(self, time, self.uv_shape,
    ...
    def uv_range_at_tstep(self, tstep, *, remask=False):
        ...
        return Observation._uv_range_at_tstep_1d(self, tstep, self.uv_shape,
                                                 axis=self._along_slit_uv_index,
                                                 remask=remask)
