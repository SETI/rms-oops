...
def test_flatfov():
    ...
    assert xy[  0,  0] == (-50./2048., 75./2048.)
    assert xy[100,  0] == ( 50./2048., 75./2048.)
    assert xy[  0,100] == (-50./2048.,-25./2048.)
    assert xy[100,100] == ( 50./2048.,-25./2048.)

    uv_test = test.uv_from_xy(xy)
    assert uv_test == Pair(buffer)
