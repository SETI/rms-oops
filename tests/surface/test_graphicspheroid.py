##########################################################################################
# tests/surface/test_graphicspheroid.py
##########################################################################################
...
def test_graphicspheroid():
    ...
    assert diff.sep(planet.normal(track)).max() < 1.e-10
    ...
    assert (lat3 - lat2).abs().max() < 3.e-12
