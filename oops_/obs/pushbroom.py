...
class Pushbroom(Observation):
    ...
    def __init__(self, axis, tstride, texp,
        ...
        Input:
            axis        0 or 1, indicating whether the u-axis of the v-axis is
                        correlated with time.
            tstride     the time in seconds from the start of one row or column
                        of the image to the start of the next.
