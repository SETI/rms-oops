...
# 8/18/13 MRS - Added gridless backplanes "pole_clock_angle" and
#   "pole_position_angle" and full backplanes "celestial_north_angle" and
...
class Backplane(object):
    ...
    ############################################################################
    # Sky geometry, pixel-by-pixel versions
    #   right_ascension()           right ascension of field of view, radians.
    #   declination()               declination of field of view, radians.
    #   celestial_north_angle()     direction of celestial north, measured from
    #                               from the image's U-axis toward the V-axis.
    #   celestial_east_angle()      direction of celestial east, measured from
    #                               the image's U-axis toward the V-axis.
    ############################################################################
