...
class Event(object):
    ...
    def __init__(self, time, pos, vel, origin, frame=None,
        ...
        # Absolute event case
        if registry.is_id(origin) or registry.is_path(origin):
            self.origin = None
        ...
        if frame is not None:
            self.frame_id = registry.as_path_id(frame)
...
############################################
    ...
    def wrt_path(self, path, quick=False):
        ...
        path = registry.connect_paths(path, event.origin_id, event.frame_id)
    ...
    def __sub__(self, arg):
        ...
        if registry.is_id(arg) or registry.is_path(arg):
    ...
    def __div__(self, arg):
        ...
        if registry.is_id(arg) or registry.is_frame(arg):
