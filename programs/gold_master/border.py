...
##########################################################################################
"""Gold master tests of the border backplanes.

The border backplanes identify the pixels along the edge of a mask or along a boundary
in the values of another backplane.
"""
