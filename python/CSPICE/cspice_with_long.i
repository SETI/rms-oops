...
%apply (int DIM1, long *SIZE1, double OUT_ARRAY1[ANY])
                            {(int maxn, long *dim, double values[80])};
...
%apply (double OUT_ARRAY2[ANY][ANY], long *SIZE1)
...
%apply (double OUT_ARRAY2[ANY][ANY]) {cmat[3][3]};
%apply (double OUT_ARRAY1[ANY])      {  av[3]   };
...
%apply (char *CONST_STRING) {char *ck};
%apply (long OUT_ARRAY1[ANY], long *SIZE1) {(long body_ids[200],
                                             long *bodies)};
...
%apply (int DIM1, int DIM2, long *NSTRINGS, char OUT_STRINGS[ANY][ANY])
                {(int room, int lenout, long *n, char cvals[80][256])};
...
%apply (int DIM1, long *SIZE1, double OUT_ARRAY1[ANY])
                            {(int room, long *n, double values[80])};
...
%apply (int DIM1, long *SIZE1, int OUT_ARRAY1[ANY])
                                    {(int room, long *n, int ivals[80])}
...
%apply (int DIM1, int DIM2, long *NSTRINGS, char OUT_STRINGS[ANY][ANY])
                {(int room, int lenout, long *n, char kvars[80][256])};
...
%apply (double **OUT_ARRAY2, long *SIZE1, long *SIZE2)
                          {(double **mout, long *nr_out, long *nc_out)};
...
%apply (double   *IN_ARRAY1, int  DIM1)
                        {(double *v2, int nr2)};
%apply (double **OUT_ARRAY1, long *SIZE1)
                        {(double **v3, long *nr3)};
...
%apply (int DIM1, long *IN_ARRAY1) {(int n, int *ivals)};
...
%apply (double OUT_ARRAY2[ANY][ANY], long *SIZE1)
                        {(double pstartstop[100][2], long *nparts)};
...
%apply (double **OUT_ARRAY1, long *SIZE1) {(double **v2, long *nd2)};
...
%apply (double **OUT_ARRAY1, long *SIZE1) {(double **v3, long *nd3)};
...
%apply (double   *IN_ARRAY1, int   DIM1) {(double  *v1, int   nd1)};
%apply (double   *IN_ARRAY1, int   DIM1) {(double  *v2, int   nd2)};
%apply (double **OUT_ARRAY1, int *SIZE1) {(double **v3, long *nd3)};
